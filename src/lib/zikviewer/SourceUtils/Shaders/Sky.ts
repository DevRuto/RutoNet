...
import { Uniform1I, UniformMatrix4, UniformSampler } from '../../Facepunch/WebGame/Uniform';
import { VertexAttribute } from '../../Facepunch/WebGame/VertexAttribute';
import { Camera } from '../Entities/Camera';
import { BaseMaterial, BaseShaderProgram } from './BaseShaderProgram';

export class SkyMaterial extends BaseMaterial {
    facePosX: Texture = null;
    faceNegX: Texture = null;
    facePosY: Texture = null;
    faceNegY: Texture = null;
    facePosZ: Texture = null;
    faceNegZ: Texture = null;
    hdrCompressed = false;
    aspect = 1;
