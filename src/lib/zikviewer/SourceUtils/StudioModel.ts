import { IVector3, Matrix4, Vector3, Vector4 } from '../Facepunch/Math';
import { IMeshData } from '../Facepunch/WebGame/MeshGroup';
import { MeshHandle } from '../Facepunch/WebGame/MeshHandle';
import { MeshManager } from '../Facepunch/WebGame/MeshManager';
import { RenderResource } from '../Facepunch/WebGame/RenderResource';
...
import { IMaterialGroup } from './LeafGeometryLoader';
    ...
    onLoadValues(page: IVertexLightingPage): void {
        ...
        for (let i = 0, iEnd = page.props.length; i < iEnd; ++i) {
            ...
            for (let j = 0, jEnd = srcProp.length; j < jEnd; ++j) {
                dstProp[j] = Utils.decompress(srcProp[j]);
            }
        }
