import { Quaternion, Vector2, Vector3 } from '../Facepunch/Math';
import { Game } from '../Facepunch/WebGame/Game';
import { AmbientLoader } from './AmbientLoader';
import { BspModelLoader } from './BspModel';
import { DispGeometryLoader } from './DispGeometryLoader';
import { Camera } from './Entities/Camera';
import { LeafGeometryLoader } from './LeafGeometryLoader';
import { Map } from './Map';
import { MapMaterialLoader } from './MapMaterialLoader';
import { StudioModelLoader, VertexLightingLoader } from './StudioModel';
import { VisLoader } from './VisLoader';
import { Key } from '../Facepunch/WebGame/Input';
...
export class MapViewer extends Game {
    ...
    loadMap(url: string, baseurl: string): void {
        this.map.load(url, baseurl);
    }
