import { IVector3, Vector3 } from '../Math';
import { DrawableEntity } from './DrawableEntity';
import { Game } from './Game';
import { Material } from './Material';
import { MeshGroup } from './MeshGroup';
import { DrawMode, MeshHandle } from './MeshHandle';
import { DebugLineProps } from './Shaders/DebugLine';
import { VertexAttribute } from './VertexAttribute';
import * as DebugLineShader from './Shaders/DebugLine';
...
export class DebugLine extends DrawableEntity {
    ...
    private readonly materialProps: DebugLineShader.DebugLineProps;
    ...
    constructor(game: Game) {
        ...
        this.game = game;
        this.material = game.shaders.createMaterial(DebugLineShader.DebugLine, true);
        this.materialProps = this.material.properties as DebugLineProps;
