...
import { ICompressedMeshData, IMeshData, IMeshElement, MeshGroup } from './MeshGroup';
import { DrawMode, MeshHandle } from './MeshHandle';
import { ComposeFrame } from './Shaders/ComposeFrame';
            ...
            elements: [
                {
                    ...
                    material: this.game.shaders.createMaterial(ComposeFrame, false),
                    indexOffset: 0,
                    indexCount: 6
                }
            ]
